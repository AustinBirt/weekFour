...
/*
A. 1. the elements in an array are called elements.
2. yes, arrays guarantee they will be in order
3. You would model a list of things/items with an array
B. 1. let quotes=['he who eats last saves his hunger', 'he who hungers does not live fully','he who lives fully, reaches nirvana']
C.1. const randomThings=[1,10,'hello',true];
