...
//Qyuestion 15
// let newArray= nums.reduce((total, initial)=>{
//     return total+initial
// })
// console.log(newArray);

// let newArray=panagram.reduce((total, initial)=>{
//     return total + initial
// })
...
// console.log(newArray);
// //no becasue it goes basedon the first number onlly

// console.log(panagram.sort());
//no i believe its because capital letters are seen as being higher in value than
//lower case. And then the lower case are alphabetized after




// let ascend=function(b,a){
//     if (a<b){
//         return -1
//     }
//     if (a>b){
...
// let newArray=panagram.sort(ascend);
// console.log(newArray);
